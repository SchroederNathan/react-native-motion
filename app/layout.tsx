    ...
    >
      <body className="min-h-full flex flex-col">
        <Navbar
          ...
          actions={
            <>
              <a href="https://github.com/SchroederNathan/react-native-motion" className="inline-flex items-center py-1 text-taupe-700 hover:text-taupe-800 dark:text-taupe-300 dark:hover:text-taupe-200 max-sm:hidden" aria-label="GitHub">
