...
const PromptActions = dynamic(
  () => import('./prompt-actions').then((m) => m.PromptActions),
  {
    ssr: false,
    loading: () => (
      <div className="inline-flex items-stretch border-shadow rounded-lg bg-taupe-800 dark:bg-taupe-300">
        <div className="inline-flex items-center gap-1.5 rounded-l-lg px-3 py-1 border-r border-taupe-50/15 dark:border-taupe-950/10">
          <svg width={16} height={16} viewBox="0 0 24 24" fill="none" className="shrink-0 text-taupe-50 dark:text-taupe-950">
