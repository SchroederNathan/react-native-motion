...
A **stacked card carousel** plus **blurred backdrop crossfade**. On index 0 the cards sit in a fanned deck; the first swipe blends them into a centered carousel. The backdrop crossfades blurred images to the active card.
