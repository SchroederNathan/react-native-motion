        ...
        {({ open }) => (
          ...
          <MenuItem>
            <button
              ...
              className="group flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm text-taupe-700 focus:outline-none data-[focus]:bg-taupe-200 dark:text-taupe-300 dark:data-[focus]:bg-taupe-900 cursor-pointer"
            >
