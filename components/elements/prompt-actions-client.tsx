...
const PromptActions = dynamic(
  () => import('./prompt-actions').then((m) => m.PromptActions),
  {
    ssr: false,
    loading: () => (
      <div className="inline-flex items-stretch border-shadow rounded-lg">
        <div className="inline-flex items-center gap-1.5 rounded-l-lg px-3 py-1 border-r border-taupe-950/10 dark:border-taupe-50/15">
          <svg width={16} height={16} viewBox="0 0 24 24" fill="none" className="shrink-0 text-taupe-800 dark:text-taupe-300">
          ...
          <span className="text-sm/7 font-medium text-taupe-800 dark:text-taupe-300">Copy prompt</span>
        </div>
        <div className="inline-flex items-center justify-center rounded-r-lg px-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4 text-taupe-800 dark:text-taupe-300">
