export const meta = {
  title: 'Radial Menu',
  slug: 'radial-menu',
  description: 'A radial menu that springs out from a long press. Actions grow as your finger nears them, and the fan adjusts to stay clear of the screen edges.',
...
A long-press radial menu that opens from the touch point. Blur dims the screen, the pressed card clones into the overlay, and circular actions spring out. Buttons grow as the finger nears and shift aside so it never covers them. Release on a button to select it, with a haptic tick. Fan angles adjust so actions stay clear of the screen edges.
